...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setResult = function () {
    ...
    if (result === false) {
      _this.info = info;
      if (tag) {
        _this.invalid.push({ tag: tag, info: info });
      }
    }
  };

  this.getInvalidTags = function () {
    return (0, _common.removeDuplicate)(_this.invalid.map(function (item) {
      return item.tag;
    }));
  };

  this.getInvalidInfo = function () {
    return _this.invalid.reduce(function (info, next, index) {
      return _extends({}, info, _defineProperty({}, next.tag, _extends({}, next, {
        index: index
      })));
    }, {});
  };
...
var _initialiseProps2 = function _initialiseProps2() {
  ...
  this.getInvalidTags = function () {
    return (0, _common.removeDuplicate)(_this2.invalid.map(function (item) {
      return item.tag;
    }));
  };

  this.getInvalidInfo = function () {
    return _this2.invalid.reduce(function (info, next, index) {
      return _extends({}, info, _defineProperty({}, next.tag, _extends({}, next, {
        index: index
      })));
    }, {});
